        ...
        <div className="p-5 flex flex-col">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className={`px-4 py-2 border rounded flex flex-col items-center gap-2 ${activeTab === "CreditCard" ? "bg-gray-300" : "bg-white"
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 border rounded flex flex-col items-center gap-2 ${activeTab === "BankTransfer" ? "bg-gray-300" : "bg-white"
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 border rounded flex flex-col items-center gap-2 ${activeTab === "CashOn" ? "bg-gray-300" : "bg-white"
                }`}
            >
