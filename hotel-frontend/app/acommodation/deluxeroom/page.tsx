...
const Page: React.FC = () => {
  ...
  const images = [
    "https://assets.anantara.com/image/upload/q_auto,f_auto,c_limit,w_1045/media/minor/anantara/images/anantara-siam-hotel/accommodation/details-page-2024/01-deluxe-room/anantara_siam_bangkok_hotel_deluxe_room_highlight_gallery_1_800x475.jpg",
    "https://assets.anantara.com/image/upload/q_auto,f_auto,c_limit,w_1045/media/minor/anantara/images/anantara-siam-hotel/accommodation/details-page-2024/01-deluxe-room/anantara_siam_bangkok_hotel_deluxe_room_highlight_gallery_2_800x475.jpg",
    "https://assets.anantara.com/image/upload/q_auto,f_auto,c_limit,w_1045/media/minor/anantara/images/anantara-siam-hotel/accommodation/details-page-2024/01-deluxe-room/anantara_siam_bangkok_hotel_deluxe_room_highlight_gallery_4_880x475.jpg",
  ];
    ...
    <div>
      ...
      <div className="bg-white">
        <div className="container flex flex-col justify-center items-center">
          <h1 className="text-[40px] xl:text-[60px] text-primary pt-10">Deluxe Room</h1>
            ...
            <div className="flex flex-col xl:flex-row w-full justify-between gap-20 py-10 animate-class">
              ...
              <div className="flex flex-col justify-center items-start gap-5 w-full">
                ...
                <p className="text-base text-black">
                  Our Deluxe Rooms at Siam Hotel Bangkok use a classy colour
                  scheme against a white wooden backdrop. Admire the exquisite
                  Thai art in the rooms based on the famous murals made of
                  authentic Thai silk hand-woven and painted by one of the most
                  famous traditional murals in Thailand. Take in the stunning
                  views through the large windows and relax in the deep soaking
                  tub in your marble bathroom. And enjoy luxurious facilities.
                </p>
                <h2 className="font-bold text-[20px] text-primary">
                  5,220 THB
                </h2>
