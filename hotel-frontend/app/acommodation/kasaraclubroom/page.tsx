            ...
            <div className="flex flex-col xl:flex-row w-full justify-between gap-20 py-10 animate-class">
              ...
              <div className="flex flex-col justify-center items-start gap-5 w-full">
                <h1 className="font-bold text-[30px] text-black">
                  Take your stay at a luxury hotel in Bangkok to the next level.
                </h1>
                <h2 className="font-bold text-[20px] text-primary">
                  Room left : 10
                </h2>
                <p className="text-base text-black">
                  Located on the upper floors of the Siam Bangkok Hotel, the
                  Club Rooms offer exclusivity, comfort and premium views over
                  the prestigious heart of the metropolis that originally
                  belonged to His Majesty the King. Before the royal gift to the
                  people in Bangkok. This contemporary space is decorated with
                  fine fabrics and large sofas for relaxing. Enjoy access to
                  KASARA Executive Lounge throughout the day
                </p>
                <h2 className="font-bold text-[20px] text-primary">
                  8,010 THB
                </h2>
